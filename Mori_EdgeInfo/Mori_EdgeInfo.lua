...
do  
  ...
  local UPDATE_INTERVAL_GLOBAL = 0.01
  local UPDATE_INTERVAL_SERVER_INFO = 2
  ...
  local WINRATE = L=="ruRU" and "Винрейт" or "WRATE"
  ...
  local RezTimer_Data, bg_statistics
  ...
  local function GetBgInfoText()
    ...
    if bgstats then
      ...
      local winrate = games > 0 and format("%.1f", (wins / games *100)) or 0
      ...
      local games = tonumber(GetStatistic(ACHIV_CATEGORY_ID_BATTLEGROUNDS_PLAYED)) or 0
      local wins = tonumber(GetStatistic(ACHIV_CATEGORY_ID_BATTLEGROUNDS_WON)) or 0
      local winrate = games > 0 and format("%.1f", (wins / games *100)) or 0
      local wrColor = games > 0 and RGBGradient(1 - (wins / games *100) / 100) or "999999"
      
      text = GAMES..":  |cccffff88"..games.."|r    "..WINS..":  |cccffff88"..wins.."|r    "..WINRATE..":  |ccc"..wrColor..""..winrate.."|r"
    end
  ...
  local function GetStatsText()
    ...
    local spdOrAp, crit, haste, hexcolor, hexcolorCrit, hexcolorHaste, hit, hexHitColor
    ...
    if showAttackPower or isHunter then
      ...
      hexHitColor = RGBGradient(1 - hit / 230)
    elseif showSpellPower then
      hexcolor = RGBGradient(1 - spdOrAp / 3500)
      --hexcolorHaste = RGBGradient(haste / 2000)
      hexcolorHaste = RGBGradient(1 - haste / 1300)
      hexHitColor = RGBGradient(1 - hit / 290)
    end
    ...
    text = text .. ":  |cff" ..hexcolor .."" ..spdOrAp .."|r    "..RES..":  |cff"..resColor..""..res.."|r    "..CRIT..":  |cff" ..hexcolorCrit .."" .. format("%.0f", crit) .. "|r    "..HASTE..":  |cff" .. hexcolorHaste .. "" ..format("%.0f", haste) .. "|r    "..HIT..":  |cff" .. hexHitColor .. ""..hit.."|r"
...
do
  ...
  local function RGBGradient(num)
    ...
    local function GameMenu_OnEnter()
      ...
      if mouseFocus and mouseFocus.GetName and mouseFocus == MainMenuMicroButton then
